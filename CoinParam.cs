...
namespace Lib {
    public class CoinParam {
        public class Bitcoin : Coin {
            ...
            public override byte PubKeyHash {
                get { return 0x00; }
            }
            public override byte PubKeyScript {
                get { return 0x05; }
            }
            public override byte PrivKey {
                get { return 0x80; }
            }
        }
        public class BitcoinTestnet : Coin {
            public override string Name {
                get { return "BitcoinTestnet"; }
            }
            public override byte PubKeyHash {
                get { return 0x6F; }
            }
        ...
        public class Coin {
            ...
            public virtual byte PubKeyScript {
                get { throw new NotImplementedException(); }
            }
            ...
            static Coin[] cbuffer = null;
            public static Coin[] getAllCoins() {
                if (cbuffer == null) cbuffer = new Coin[] { new Bitcoin(), new BitcoinTestnet(), new Litecoin(), new Dogecoin(), new Vertcoin() };
                return cbuffer;
            }
        }
    }
  ...
  626, 978, 825, 344, 605, 654, 209
        ...
        private static readonly byte[] Byteset =  Encoding.ASCII.GetBytes("qpzry9x8gf2tvdw0s3jn54khce6mua7l");
        ...
        public Bech32Encoder(string hrp) : this(hrp == null ? null : Encoding.ASCII.GetBytes(hrp)) {
        }
        ...
        bool VerifyChecksum(byte[] data, int bechStringLen, out int[] errorPosition) {
            ...
            var polymod = Polymod(values.ToArray()) ^ 1;
            if (polymod != 0) {
        ...
        public byte[] DecodeData(string encoded) {
            ...
            buffer = Encoding.ASCII.GetBytes(encoded);
            var hrp = Encoding.ASCII.GetBytes(encoded.Substring(0, pos));
        ...
        public string Encode(byte witnessVerion, byte[] witnessProgramm) {
            ...
            var ret = EncodeData(data.ToArray(), 0, data.ToArray().Length);
            return ret;
        }
    }
}
